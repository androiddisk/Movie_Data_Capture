...
G_TAKE_NUM_RULES = {
    ...
    'mdg': lambda x: str(re.search(r'mdg(-|_)(\d{4})', x, re.I).group()),
    'mds': lambda x: str(re.search(r'mds(-|_)(\d{4})', x, re.I).group()),
    'mdyd': lambda x: str(re.search(r'mdyd(-|_)(\d{4})', x, re.I).group()),
    'pms': lambda x: str(re.search(r'pms(-|_)(\d{4})', x, re.I).group()),
